...
const CULTURAL_NOTES = {
  'DB001': '太阳崇拜是纳西族万物有灵信仰的核心，东巴教将太阳视为光明与生命的源泉',
  ...
  'DB020': '老虎是纳西族图腾崇拜的对象，东巴经《虎的故事》记载着虎与纳西先民的深厚渊源',
  'DB021': '大鹏神鸟（纳西语称"都盘修曲"，意为白海螺色的大鹏）是东巴什罗的三大护法神之一，象征正义与力量',
  'DB022': '青蛙在纳西族信仰中象征雨水与繁殖，其叫声被视为大地与天神沟通的媒介',
  ...
  'DB036': '法螺是东巴仪式的重要法器，其声音被认为能驱邪避鬼、传递神音',
  'DB037': '法鼓声震天地，东巴法师击鼓通神，引导亡灵穿越三界',
  'DB038': '双鱼纹样象征吉祥丰收，源于纳西族对金沙江渔猎文化的记忆',
